...
class Node:
    def __init__(self, walkable, world_position, grid_x, grid_y, cost=1, right=False, left=False, kavsak=False):
    ...
    def __init__(self, grid_data):
        ...
        for node_data in grid_data['nodes']:
            ...
            self.grid[x][y] = Node(
                    ...
                    x,
                    y,
                    right=node_data.get('right', False),
                    left=node_data.get('left', False),
                    kavsak=node_data.get('kavsak', False)
            )
